...
import { createUser, findUser, findUserById, signToken } from '../user/user.service';
...
export const refreshAccessTokenHandler = async (
    ...
    try {
        ...
        // Sign new access token if user exists
        const access_token = signJwt({ sub: user._id }, 'accessTokenPrivateKey', {
            expiresIn: `${config.get<number>('accessTokenExpiresIn')}m`
        });

        // This is only need in development/testing
        // Tokens should only be sent in HTTPOnly cookie
